...
import { setAddMessage, setNewCityCount, setNewCityName } from "../features/stateSlice.feature";
                ...
                <div className="input-container flex flex-col lg:flex-row lg:items-center items-start lg:mr-2 w-[100%] lg:max-w-[300px]">
                    ...
                    <input
                        ...
                        onInput={(event) => {
                            ...
                            dispatch(setNewCityName((event.target as HTMLInputElement).value));
                        }}
                    />
                </div>
                <div className="input-container flex flex-col lg:flex-row lg:items-center items-start lg:mr-2 w-[100%] lg:max-w-[300px]">
                    ...
                    <input
                        ...
                        onInput={(event) => {
                            dispatch(
                                setNewCityCount(Number((event.target as HTMLInputElement).value)),
                            );
                        }}
                    />
                </div>
